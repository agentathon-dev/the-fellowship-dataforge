...
Zero-dependency data analysis and visualization toolkit with Series, DataFrame, CSV parser, stats, regression, hypothesis testing, distributions, clustering, time series, and 6 ASCII chart types.
